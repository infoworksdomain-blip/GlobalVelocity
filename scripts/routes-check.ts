...
const routes: R[] = [
  ...
  { group: "App", path: "/app/ghost-mode", label: "Ghost Mode", kind: "page", auth: true },
  ...
  { group: "API", path: "/api/v1/ugc-clips/categories", label: "UGC categories", expectText: '"categories"', kind: "api", auth: true },
